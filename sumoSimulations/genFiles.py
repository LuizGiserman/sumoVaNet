...
index = ''
directories = ['semAcostamento/aggressive/']#, 'semAcostamento/lc2013/']# 'comAcostamento/lc2013', 'comAcostamento/aggressive']#, 'semAcostamento/'] #'comSaidas/', 'comSaidasEntradas/', ]
